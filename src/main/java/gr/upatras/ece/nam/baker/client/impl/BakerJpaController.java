...
import gr.upatras.ece.nam.baker.client.model.ApplicationMetadata;
import gr.upatras.ece.nam.baker.client.model.BakerProperty;
import gr.upatras.ece.nam.baker.client.model.BakerUser;
import gr.upatras.ece.nam.baker.client.model.BunMetadata;
import gr.upatras.ece.nam.baker.client.model.Category;
import gr.upatras.ece.nam.baker.client.model.DeploymentDescriptor;
import gr.upatras.ece.nam.baker.client.model.InstalledBun;
import gr.upatras.ece.nam.baker.client.model.Product;
...
//			System.setProperty("marketplace_api_endpoint", "http://83.212.106.218:8080/baker");
		...
		if ( System.getProperty("baker_client_owner_id") == null ){
			System.setProperty("baker_client_owner_id", "1");
		}
		
		if ( System.getProperty("baker_client_owner_username") == null ){
			System.setProperty("baker_client_owner_username", "admin");
		}
		
		logger.info("marketplace_api_endpoint = "+ System.getProperty("marketplace_api_endpoint") );
		logger.info("BakerCLient! UUID = "+ this.readPropertyByName("UUID").getValue()); //949a868c-2424-4f27-928d-6da5bd14b92e
		
		
	}

	public long countInstalledBunsX() {
